...
const caseStudies = [
  {
    ...
    budget: "$56.7K",
    roas: "794.83%",
    result: "Revenue: $451K+ | 8x ROAS",
    gradient: "from-blue-500 to-cyan-500",
    metrics: [
      { label: "Budget", value: "$56,700", icon: DollarSign },
      { label: "Revenue", value: "$451K+", icon: TrendingUp },
      { label: "ROAS", value: "8x", icon: Target },
    ],
  },
  {
  ...
  },
  {
    ...
    budget: "$1,016",
    roas: "37.14x",
    result: "Revenue: $37,747 | Extreme ROAS growth",
    gradient: "from-green-500 to-emerald-500",
    metrics: [
      { label: "Budget", value: "$1,016", icon: DollarSign },
      { label: "Revenue", value: "$37,747", icon: TrendingUp },
